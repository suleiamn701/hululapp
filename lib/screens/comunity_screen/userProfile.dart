...
import 'package:hululapp/screens/comunity_screen/commons/youtubepromotion.dart';
import 'package:hululapp/screens/comunity_screen/subViews/changeUserIcon.dart';
...
class _UserProfile extends State<UserProfile>{
  ...
  Future<void> _updateMyData(String newName, String newThumbnail) async{
    ...
    MyProfileData newMyData = MyProfileData(
        myName: newName,
        myThumbnail: newThumbnail, myLikeCommnetList: [], myFCMToken: '', myLikeList: []
    );
